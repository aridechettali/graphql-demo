...
public class GraphQLClient {
    public static void main(String[] args) {
        ...
        apolloClient.query(new BookDetailQuery("book-1")).enqueue(new ApolloCall.Callback<java.util.Optional<BookDetailQuery.Data>>() {
            @Override
            public void onResponse(@NotNull Response<java.util.Optional<BookDetailQuery.Data>> response) {
        ...
        apolloClient.query(new BookDetailsQuery()).enqueue(new ApolloCall.Callback<java.util.Optional<BookDetailsQuery.Data>>() {
            @Override
